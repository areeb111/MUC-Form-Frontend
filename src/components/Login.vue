<template>
  <div id="loginPage">
    <v-row class="fill-height pa-0 ma-0">
      <v-col
        class="baseBackground d-flex align-center justify-center"
        style="
          box-shadow: 0 2px 10px 0 rgb(19 17 32 / 10%) !important;
          border-left: thin solid rgba(231, 227, 252, 0.14) !important;
          width: 100%;
        "
        cols="12"
        md="4"
      >
        <div class="pa-10" style="width: 100%">
          <center>
            <Logo :width="100" />
            <h2>جامعة دجلة</h2>
          </center>
          ...
          <v-text-field
            ...
            append-icon="ti-key"
          ></v-text-field>
          <v-btn @click="login()" block rounded class="super">
            <span>دخول</span>
          </v-btn>
        </div>
      </v-col>
      <v-col align="center" class="d-flex flex-column align-center justify-center">
        <h1>اهلاً بك في البوابة الالكترونية للنظام الاكاديمي</h1>
        <br>
        <h2>قم بادخال اسم المستخدم وكلمة المرور الخاصة بك للمتابعة</h2>
      </v-col>
    </v-row>
  </div>
</template>
